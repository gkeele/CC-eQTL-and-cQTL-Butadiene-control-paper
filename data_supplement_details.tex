...
\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Founder haplotype mosaics for the 47 strains based on Build37, derived from files at \url{http://csbio.unc.edu/CCstatus/index.py?run=FounderProbs}, used for haplotype-based QTL analysis. Haplotype intervals were thinned, averaging adjacent intervals for which the mean l2 norm $<$ 0.1 \cite{Keele2019}. Data are arranged into a directory tree structure  (genome cache) that conforms to the HAPPY format \cite{Mott2000}.
		\end{itemize}
