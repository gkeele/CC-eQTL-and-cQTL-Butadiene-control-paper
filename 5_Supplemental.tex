...
\hline
%%%%%%%%%%%%%%%%
Method 3\footnote{10 Mb upstream or downstream of the gene TSS with local-eQTL that meets chromosome-wide significance through Method 3. Additionally, chromatin mediator must possess a local-cQTL that meets chromosome-wide significance through Method 3.} & genome-wide & 30 (1.8\footnote{Percentage of genes with a chromatin mediator that meet chromosome-wide significance for a local-eQTL through Method 3.\label{fn:mediator_perc}}) & 68 (3.6\footref{fn:mediator_perc}) & 46 (2.2\footref{fn:mediator_perc}) \\
& chromosome-wide & 70 (4.2\footref{fn:mediator_perc}) & 181 (9.6\footref{fn:mediator_perc}) & 137 (6.5\footref{fn:mediator_perc}) \\
\hline
\end{tabularx}
\end{tableminipage}
\end{table*}
