...
\caption{\textbf{Concordance between DE genes and DARs in between-tissue comparisons.} DE genes were categorized by direction of DE and chromatin accessibility in their promoter regions.\label{fig:diff_concordance}}
\end{figure*}
...
\caption{\textbf{CAST and PWK alleles have more extreme effects for eQTL than the other strains.}
...
\caption{\textbf{CAST and PWK alleles have more extreme effects for cQTL than the other strains.} 
...
\caption{\textbf{Effect sizes are slightly correlated for QTL pairs.}
...
\caption{\textbf{QTL pairs with highly correlated founder allele effects tend to map near each other.}
...
\caption{\textbf{Enrichment detected in QTL pairs with significantly correlated founder allele effects.}
...
\caption{\textbf{Full mediation model of distal-eQTL of \textit{Akr1e1}.} \label{fig:akr1e1_exmediation}}
\end{figure*}

\begin{figure*}[hp]
\renewcommand{\familydefault}{\sfdefault}\normalfont
\centering
\includegraphics[width=\textwidth, trim={1in 0in 1in 0in}, clip]{figs/akr1e1_observed_relationships.pdf}
\caption{\textbf{Observed relationships related to the \textit{Akr1e1} distal-eQTL.} \label{fig:akr1e1_exmediation}}
\end{figure*}
