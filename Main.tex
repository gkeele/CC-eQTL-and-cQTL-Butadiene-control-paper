...
\affil[$\dagger\dagger\dagger$]{Center for Omics Discovery and Epidemiology, Research Triangle Institute (RTI) International, Research Triangle Park, NC\hspace{17cm} ORCID IDs: 
...
Author contributions: GRK, BCQ, and TSF wrote the manuscript. GRK and WV developed the statistical methods for QTL analysis, and GRK wrote the software to perform the respective analyses. BCQ processed the sequence data and performed the differential expression and accessible analyses. GRK and BCQ performed all QTL and mediation analyses. The authors declare no conflicts of interest.
