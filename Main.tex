...
\title{QTL analysis in the Collaborative Cross mouse population reveals multi-tissue patterns of genetic regulation spanning gene expression and chromatin accessibility}


\author[$\ast$,$\dagger$,$\ddagger$]{Gregory R. Keele}
\author[$\ast$,$\dagger$,$\ddagger$,$\ast\ast\ast$]{Bryan Quach}
...
\affil[$\ast\ast\ast$]{Center for Omics Discovery and Epidemiology, Research Triangle Institute (RTI) International\hspace{17cm} ORCID IDs: 
0000-0002-1843-7900 (G.R.K.), 0000-0002-2419-0430 (W.V.)}

\keywords{multiparental populations, MPP, mediation, QTL, genome-wide association}

\runningtitle{Tissue-specific quantitative trait locus analysis} % For use in the footer 
