...
<<<<<<< HEAD
\textbf{Conceptualization:} Ivan Rusyn, Terrence S. Furey, Gregory E. Crawford, Gregory R. Keele, William Valdar
...
\noindent \textbf{Investigation:} Terrence S. Furey, Ivan Rusyn, Gregory E. Crawford

\noindent \textbf{Methodology:} Gregory R. Keele, Bryan C. Quach, William Valdar

\noindent \textbf{Software:} Gregory R. Keele
...
=======
>>>>>>> 66e5443e40a9e9bc3405dcd0871339d42525b095

\noindent \textbf{Conceptualization:} IR, TF, GC, GK, WV
 
\noindent \textbf{Data Curation:} JI, JS, PC, (FW, YZ)
 
\noindent \textbf{Formal Analysis:} GK, BQ
 
\noindent \textbf{Funding Acquisition:} TF, IR, GC
 
\noindent \textbf{Investigation:} GAC, LL, AS,
 
\noindent \textbf{Methodology:} GK, WV
 
\noindent \textbf{Project Admin:} TF, IR, GC, WV
 
\noindent \textbf{Software:} GK, BQ
 
\noindent \textbf{Supervision:} TF, IR, WV, GC
 
\noindent \textbf{Visualization:} GK, BQ
 
\noindent \textbf{Writing – Original:} GK, BQ
 
\noindent \textbf{Writing – Review:} TF, WV, IR
