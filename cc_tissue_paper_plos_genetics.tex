...
Cytochrome c oxidase subunit 7C (\textit{Cox7c}) is an example of a gene that possesses local-eQTL with highly correlated effects in all three tissues (Fig \ref{fig:correlated_local_eqtl}A).
