...
Author contributions: GRK, BQ, WV, and TSF wrote the manuscript. GRK, BQ, and WV developed the statistical methods for QTL analysis, and GRK wrote the software to perform the respective analyses. BQ processed the sequence data and performed the DE and DAR analyses. GRK and BQ performed all QTL and mediation analyses. The authors declare no conflicts of interest.
