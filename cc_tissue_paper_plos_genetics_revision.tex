...
\GKinline{The CC and DO, and MPPs more broadly, due to their well-characterized founder haplotypes provide a unique opportunity for haplotype-based mediation analyses whereas SNP-based analyses are commonly used in human studies.}
...
Genes with multiple tissue-\TFinline{selective} local-eQTL potentially reflect different functional variants, and could potentially have less consistent patterns of variant association compared to variants that are functionally active in multiple tissues.
